            ...
            <div class="row">
               <div class="col m3">  
                ...
                <div class="col m9" style="margin-top:30px">
                    ...
                    <a href="" class="breadcrumb"><?php echo $val['name']; ?> - Decorations Department</a>                    
                </div>
                                                ...
                                                <ul class="collection">
                                                    ...
                                                    <i class="material-icons circle red">toys</i>
                                                        ...
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors/search/venues" class="btn blue waves-light waves-effect">Suggested</a> 
                                                    ...
                                                    <i class="material-icons circle red">brush</i>
                                                        ...
                                                        <hr>
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors/search/caterers" class="btn blue waves-light waves-effect">Suggested</a> 
                                                    ...
                                                    <i class="material-icons circle red">directions_car</i>
                                                        ...
                                                        <hr>
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors/search/transportation" class="btn blue waves-light waves-effect">Suggested</a> 
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/collaborate/delete_transaction_decorations/<?= $event_id."/".($inc['id']*23)."/".$inc['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/collaborate/delete_transaction_decorations/<?= $event_id."/".($exp['id']*23)."/".$exp['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
